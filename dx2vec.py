...
applied to ICD9 codes, context window is a single patient

Code adapted from CS 20: "TensorFlow for Deep Learning Research"
cs20.stanford.edu
...
VOCAB_SIZE = 14567 # total number of ICD9 codes
BATCH_SIZE = 128
...
SKIP_STEP = 5000 # how often to report average loss and save checkpoint
...
class SkipGramModel:
    ...
    def train(self, num_train_steps):
        ...
        with tf.Session() as sess:
            ...
            writer = tf.summary.FileWriter('graphs/dx2vec/lr' + str(self.lr), sess.graph)
    ...
    def visualize(self, visual_fld):
        ...
        with tf.Session() as sess:
            ...
            # store embeddings in a new variable
            ...
            # link this tensor to its metadata file, in this case the
            # descriptions of ICD9 codes in the vocab
            embedding.metadata_path = 'vocab_descs.tsv'
